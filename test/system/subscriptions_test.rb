...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "should create subscription" do
    ...
    fill_in "Followers", with: @subscription.followers_id
    fill_in "Followers type", with: @subscription.followers_type
    fill_in "Follows", with: @subscription.follows_id
    fill_in "Follows type", with: @subscription.follows_type
